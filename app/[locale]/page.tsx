...
export default async function Home({
  ...
  const isFrance = locale.toLowerCase() === "fr-fr";
  const appStoreSrc = isFrance
    ? "/AppStore_icon_FR.svg"
    : "/AppStore_icon_EN.svg";
  const gStoreSrc = isFrance ? "/GStore_icon_FR.svg" : "/GStore_icon_EN.svg";
  const heroImage = t("heroImage", {
    default: "/mockup_fr_screen_lounge-1.webp",
  });
  const socialTitle = t("socialTitle", { default: "" });
  const ariaApple = t("ariaApple", { default: "" });
  const ariaGoogle = t("ariaGoogle", { default: "" });
  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden bg-[#333]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute left-0 top-0 h-[42vh] w-full lg:hidden">
          <Image
            src={heroImage}
            alt=""
            fill
            ...
            sizes="100vw"
          />
          {/* Dégradé vertical: clair en haut -> foncé en bas */}
          <div className="pointer-events-none absolute inset-0 bg-linear-to-b from-[#333]/0 via-[#333]/20 to-[#333]" />
        </div>
      ...
      {/* CONTENT */}
      <div className="relative mx-auto min-h-screen max-xl:max-w-6xl  px-6 py-10">
        {/* MOBILE: on pousse le contenu sous l’image */}
              ...
              <div className="flex max-h-full mt-8">
                <div className="flex flex-row items-center lg:mx-1 lg:gap-0.5">
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={ariaApple || undefined}
                  >
                    <Image
                      src={appStoreSrc}
                      alt=""
                  ...
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={ariaGoogle || undefined}
                  >
                    <Image
                      src={gStoreSrc}
                      alt=""
