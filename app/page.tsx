          ...
          <div className="w-full lg:py-10 ">
            <div className="text-white text-center mx-auto max-w-md lg:mx-0 lg:max-w-none lg:text-left lg:pl-8">
              ...
              <p className="mt-4 max-w-xl text-base leading-relaxed text-white/85">
                Vous êtes extrêmement nombreux à affluer sur notre site web
                suite à notre passage dans l&apos;émission &quot;Qui veut être
                mon associé&quot;.
              </p>

              <p className="mt-4 max-w-xl text-base leading-relaxed text-white/85">
                Notre site connaît un petit coup de fatigue, mais nos équipes
                sont déjà dessus.
              </p>
